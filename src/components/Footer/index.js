        ...
        <div className="row">
          <div className="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-4 order-md-1 order-lg-4 order-xl-1">
            ...
            <p className="footer__tagline">
              CollectorsMint is a next generation marketplace where artists and
              collectors can create, sell and collect digital items secured with
              blockchain.
            </p>
          ...
          <div className="col-6 col-md-4 col-lg-3 col-xl-2 order-1 order-md-2 order-lg-1 order-xl-2 offset-md-2 offset-lg-0">
            ...
            <div className="footer__nav">
              ...
              <a
                href="assets/terms/CollectorsMintPrivacyPolicy.pdf"
                target="_blank"
                rel="noreferrer"
              >
                Privacy Policy
          ...
          <div className="col-12">
            <div className="footer__content">
              <div className="footer__social">
                <a href="https://www.facebook.com/CollectorsMintMarket" target="_blank" rel="noreferrer">
                ...
                <a href="https://www.instagram.com/CollectorsMintclub/" target="_blank" rel="noreferrer">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <a href="https://twitter.com/CollectorsMintNFT" target="_blank" rel="noreferrer">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <a href="https://t.me/CollectorsMintclub" target="_blank" rel="noreferrer">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <a href="mailto:contact@collectorsmint.io" target="_blank" rel="noreferrer">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              ...
              <small className="footer__copyright">
                © 2021 CollectorsMint, Inc. All Rights Reserved.{" "}
              </small>
              <small>
                We are still in beta, with more features to come!<br/>
                Send us your feedback at feedback@collectorsmint.io
              </small>
            </div>
          </div>
        </div>
