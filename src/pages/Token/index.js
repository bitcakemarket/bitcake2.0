			...
			<div className="row row--grid">
				...
				<div className="col-12 col-xl-11">
					<div className="main__title main__title--page">
						<h1>CollectorsMint – BNB Marketplace</h1>
				...
				<div className="row">
					<div className="col-12 col-lg-8 col-xl-8">
						<div className="main__title">
							...
							<p>Many desktop publishing packages and <a href="/">web page</a> editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy.</p>

							<a href="https://vimeo.com/45830194" className="main__video open-video">Watch video</a>
						</div>
					</div>
				</div>
			</div>
		...
		<div className="container">
			<div className="row row--grid">
				...
				<div className="col-12 col-xl-8">
					<div className="main__title">
						<h2>How you can get CollectorsMint</h2>
			...
			<div className="row row--grid">
				...
				<div className="col-12 col-md-6 col-lg-4 col-xl-3">
					<div className="feature">
						...
						<h3 className="feature__title">Get airdrop <br/>as CollectorsMint user</h3>
				...
				<div className="col-12 col-md-6 col-lg-4 col-xl-3">
					<div className="feature">
						...
						<h3 className="feature__title">Hustle in CollectorsMint DAO</h3>
						<p className="feature__text">It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially</p>
					</div>
				</div>
